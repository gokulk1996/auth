...
public class AccountResourceIntTest {
    ...
    public void setup() throws Exception {
        ...
        AccountResource accountResource =
            new AccountResource(userRepository, userService, mockMailService, sitesClient);

        AccountResource accountUserMockResource =
            new AccountResource(userRepository, mockUserService, mockMailService, sitesClient);
