...
public class UserResourceIntTest {
     ...
     *
     * @see com.cme.budderfly.authenticate.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        UserResource userResource = new UserResource(userService, userRepository, mailService, mockUserSearchRepository, userMapper);
